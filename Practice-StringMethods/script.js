...
// const list = function (title, ...books) {
...
// list('My favorite books', 'Brave New World', 'The Great Gatsby', 'Pride and Prejudice', 'Pati Knyga', 'Vernono Neklausk')
...
// for (let i = 0; i < books.length; i++) {
//       books[i].otherLanguagesTitle['spanish'] && books[i].otherLanguagesTitle['korean'] && console.log(`${books[i].title} by ${books[i].author} has title in Spanish and Korean`);
// }
...
for (let i = 0; i < books.length; i++) {
      (books[i].otherLanguagesTitle['portuguese'] && !books[i].otherLanguagesTitle['spanish']) ||
            (books[i].otherLanguagesTitle['spanish'] && !books[i].otherLanguagesTitle['portuguese'])
            && console.log(`${books[i].title} by ${books[i].author} has title in Portuguese or Spanish, but not in both`);
}
